      ...
      <div className="space-y-6 max-w-md mx-auto">
        ...
        {matches.map((match: any, index: number) => {
            ...
            <div key={match.clerkId} className={`paper-card p-5 relative ${rotation} bg-white dark:bg-slate-800 transition-all duration-300 hover:z-10`}>
                ...
                {match.bio && (
                    <div className="mb-4 bg-yellow-50 dark:bg-yellow-900/10 p-3 border-l-2 border-slate-300 dark:border-slate-600 font-hand text-lg text-slate-700 dark:text-slate-300 leading-tight">
                        "{match.bio}"
                    </div>
                )}
